...
function outputLanguageRule(language) {
  return `All natural-language fields in the JSON must be written in ${sanitizeUserInput(language || 'English')}.`;
}

function syllabusPrompt(topic, difficulty, language) {
...
function practicePrompt(topic, difficulty, language) {
...
function quizPrompt(topic, difficulty, language) {
  return `${baseGuardrails()}\n${outputLanguageRule(language)}\n\nGenerate 5 MCQ questions for the topic below.\nTopic: ${sanitizeUserInput(topic)}\nDifficulty: ${sanitizeUserInput(difficulty)}\n\nJSON shape:\n{\n  "topic": "string",\n  "questions": [\n    {\n      "question": "string",\n      "options": ["string", "string", "string", "string"],\n      "correct_answer": "string",\n      "explanation": "string"\n    }\n  ]\n}`;
}

function chatPrompt(question, topic, language) {
